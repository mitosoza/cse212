...
public class TakingTurnsQueueTests
{
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: 1, Expected 'Tim' but the actual was 'Sue'. It fails when people have zero turns
    ...
    // Defect(s) Found: 1, Expected 'Tim' but the actual was 'Sue'. It fails when people have less than zero should be re-enqueded
